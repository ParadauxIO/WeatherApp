    ...
    return (
        <div className="forecast-item">
            <div className="forecast-title">
                {index === 0 && <h3> (Now) </h3>}
                {index !== 0 && <h3> (+ {index/8} day{index/8 !== 1 ? "s" : ""})</h3>}
                <h3> </h3>
            ...
            <div className="forecast-info">
                <span className="forecast-key">Current Temperature</span>
                <span className="forecast-value">{item.main.temp}</span>
            </div>
            <div className="forecast-info">
                <span className="forecast-key">Feels like</span>
                <span className="forecast-value">{item.main.feels_like}</span>
            </div>
            <div className="forecast-info">
